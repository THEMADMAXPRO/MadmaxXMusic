...
def second_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data=f"settings_back_helper_fixed"), InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data=f"settings_back_helper_fixed"), InlineKeyboardButton(text="▷", callback_data=f"settings_back_helper")]
